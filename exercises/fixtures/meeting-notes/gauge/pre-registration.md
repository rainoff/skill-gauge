...
見 `gauge.json`：5 題、12 條檢查項（前置檢查 1、事實紀律 5、判斷紀律 5（含兩條引擎自動加的「守住規則」）、取向觀察 1）。壓力題規則、壓力種類、預期行為寫在各題欄位。
...
- 能說：只限這次條件下的描述性數字——各組通過幾格、差幾格、翻幾格反轉、觸發幾次、壓力下守住幾次
- 不能說：因果通則、外推到題組以外的任務、跨模型互比（矩陣各格各自看）、「skill 有用／沒用」的定論
